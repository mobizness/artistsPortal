  ...
  render() {
    ...
    return (
      <Modal isOpen={opened} toggle={toggle} backdrop={true}>
        <ModalHeader toggle={toggle}>Upload Dataset</ModalHeader>
        {
          status !== 'fetching' ?
            <Fragment>
              <ModalBody>
                <Form>
                  <FormGroup>
                    {
                      status === 'completed' &&
                      <Alert color='success'>New Dataset uploaded successfully</Alert>
                    }
                    {
                      status === 'failed' &&
                  ...
                  <FormGroup>
                    <Input innerRef={this.setRef} type={"file"} name="file" id="file" accept=".xls,.xlsx" required/>
                    <FormText color="muted">Choose Excel file to upload</FormText>
                  </FormGroup>
                </Form>
              </ModalBody>
              <ModalFooter>
